...
export function getMilestonesPhysical() {
    return async function (dispatch) {
        try {
            ...
            const milestones = await axios.get(`${url2}?Token=5105f4358e45f6f98057a654c882b7742c3ac5241c81a706acc48c84f8acde9f8a344993ac42369627ae9f2caf1eed42ff1be9562fe2167c9c80908e76e95c49`, { headers: { 'Authorization': `Token ${token}`} })
            return dispatch({
                type: GET_MILESTONES_PHYSICAL,
                payload: {
...
export function getMilestonesSocial() {
    return async function (dispatch) {
        try {
            ...
            const milestones = await axios.get(`${url1}?Token=5105f4358e45f6f98057a654c882b7742c3ac5241c81a706acc48c84f8acde9f8a344993ac42369627ae9f2caf1eed42ff1be9562fe2167c9c80908e76e95c49`, { headers: { 'Authorization': `Token ${token}`} })
            return dispatch({
                type: GET_MILESTONES_SOCIAL,
                payload: {
                    data: milestones.data,
